...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    GateMasterApplication provideApp() {
        return GateMasterApplication.AppContext;
    }

    @Provides
    @Singleton
    Cache provideOkHttpCache(GateMasterApplication application) {
    ...
    @Provides
    Interceptor provideInterceptor(GateMasterApplication app, SharedPref sharedPref) {
        return chain -> {
